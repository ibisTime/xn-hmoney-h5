...
<script>
  ...
  export default {
    props: {
      ...
      uploadUrl: {
        type: String,
        default: 'http://up.qiniup.com' // 线上 http://up-z0.qiniup.com  测试研发   http://up-z2.qiniu.com  http://up.qiniup.com
      },
      token: {
        type: String, 
        default: '',
    ...
    methods: {
      ...
      uploadByBase64(base64, key) {
        ...
        return request.post('http://up.qiniu.com/putb64/-1/key/' + key)
